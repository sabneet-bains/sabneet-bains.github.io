...
(function(b) {
   ...
   function g() {
       ...
       function i(c, r, s) {
           f(c, r, function(a, u, l) {
               n = n.filter(function(d) {
                   return d[0] === a && d[1] === u && d[2] === l && (!s || d[3] === s) ? (d[4](),
                   !1) : !0
               })
           })
       }
       function t(c, r, s) {
           var a, u = !0;
           return typeof CustomEvent == "function" ? a = new CustomEvent(r,{
               bubbles: u,
               detail: s
   ...
   function $(n) {
       ...
       return n && n.event.on(L, i.destroy),
       C(i, {
           bus: e,
           on: t,
           off: E(i.unbind, e),
   ...
   function F(n, e, i) {
       var t = $(n), f = t.emit, o = i.intersection || {}, c = B(n), r;
       function s() {
           window.IntersectionObserver && (r = new IntersectionObserver(u,{
               root: o.root,
